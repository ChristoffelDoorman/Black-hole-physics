...
int main(int argc, char **argv) {
    ...
    // Domain 0
    resols[0]->set(0) = r0_res;
    resols[0]->set(1) = tet_res;
    resols[0]->set(2) = phi_res;
    // Domain 1
    resols[1]->set(0) = r1_res;
    resols[1]->set(1) = tet_res;
    resols[1]->set(2) = phi_res;
    // Domain 2
    resols[2]->set(0) = r2_res;
    resols[2]->set(1) = tet_res;
    resols[2]->set(2) = phi_res;
    // Domain 3
    resols[3]->set(0) = r3_res;
    resols[3]->set(1) = tet_res;
    resols[3]->set(2) = phi_res;
    // Domain 4
    resols[4]->set(0) = r4_res;
    resols[4]->set(1) = tet_res;
    resols[4]->set(2) = phi_res;
...

    {
        ...
        space.add_eq(syst, "D_j D^j bet^i + D^i D_j bet^j / 3. - 2 * A^ij * (D_j N - 6 * N * D_j Psi / Psi) = 0", "bet^i",
                     "dn(bet^i)");
    ...
    if (rank == 0) {
        char dat_name[100];
        sprintf(dat_name, "SchwSyst_%d_%d_%.1f_%.0f_%.0f.dat", r2_res, r3_res, bounds(1), bounds(2), bounds(3));
